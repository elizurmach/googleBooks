# `my-books` — the seed for AngularJS apps
...
To get you started you can simply clone the `my-books` repository and install the dependencies:

### Prerequisites

You need git to clone the `my-books` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `my-books`. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `my-books`

Clone the `my-books` repository using git:

```
git clone https://github.com/angular/my-books.git
cd my-books
```

If you just want to start a new project without the `my-books` commit history then you can do:

```
git clone --depth=1 https://github.com/angular/my-books.git <your-project-name>
```
...
app/                  --> all of the source files for the application
  ...
  book-list/                --> the book-list view template and logic
    book-list.html            --> the partial template
    book-list.js              --> the controller logic
    book-list_test.js         --> tests of the controller
...
There are two kinds of tests in the `my-books` application: Unit tests and end-to-end tests.

### Running Unit Tests

The `my-books` app comes preconfigured with unit tests. These are written in [Jasmine][jasmine],
...
The `my-books` app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
up-to-date. The `my-books` project is configured to do this automatically before running the
...
The `my-books` project supports loading the framework and application scripts asynchronously.
...
The `my-books` project comes preconfigured with a local development web server. It is a Node.js
...
your repository and execute scripts such as building the app or running tests. The `my-books`
